  ...
  return [
    {
      ...
      members: ["2020-0318", "2022-0703"], enteredCount: 2,
    },
    {
    ...
    },
    {
      ...
      members: ["2021-0442"], enteredCount: 0,
...
export function closedSessions() {
  ...
  return [
    ...
    { id: "ses-2", siteId: "site-a1", gateId: "gate-a1", workCode: "C-1",
      ...
      members: ["2015-0207", "2023-0128", "2019-0417"],
